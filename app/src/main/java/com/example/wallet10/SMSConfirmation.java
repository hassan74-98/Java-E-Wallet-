...
public class SMSConfirmation extends AppCompatActivity implements View.OnClickListener{
    ...
    //initiate the firebase database root ref
    ...
    public String ext = "@mail.com";
    private static final String TAG = "track email";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_s_m_s_confirmation);
    ...
    public void registerUser() {
        // concat hassaneloufir98@gmail.com //a@foo.com// to make phone number into email
...
/************************* hnaaaaaaa fin ghnnna rwicha**************/
                            ...
                            Toast.makeText(SMSConfirmation.this, "Something went wrong, please resend the SMS",Toast.LENGTH_SHORT).show();
                        }
